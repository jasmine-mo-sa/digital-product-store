...
export function About() {
  return (
    <section id="about" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-white dark:bg-surface" />
            ...
            <div className="relative">
              ...
              <div className="relative w-72 h-72 sm:w-80 sm:h-80">
                ...
                <div className="absolute inset-8 rounded-full overflow-hidden shadow-2xl shadow-brand-500/30">
                  <Image src="/profile.jpg" alt="Jasmine Mo" fill sizes="256px" className="object-cover object-top" />
                </div>

                {/* Floating badge — top right */}
                <div className="absolute -top-2 -right-4 bg-white dark:bg-card border border-gray-100 dark:border-white/10 rounded-2xl px-4 py-2.5 shadow-xl">
                ...
                <div className="absolute -bottom-2 -left-4 bg-white dark:bg-card border border-gray-100 dark:border-white/10 rounded-2xl px-4 py-2.5 shadow-xl">
                  <div className="flex items-center gap-2">
