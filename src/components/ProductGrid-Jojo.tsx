  ...
  return (
    <>
      <section id="products" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        {/* Background */}
        <div className="absolute inset-0 bg-gray-50/80 dark:bg-deep/80" />
...
function ProductCard({
  ...
  return (
    <article className="group relative flex flex-col rounded-3xl overflow-hidden bg-white dark:bg-card border border-gray-100 dark:border-white/5 card-hover glow-hover shadow-sm">
      {/* Product visual */}
      {(product as any).previewImage ? (
        <div className="relative aspect-[16/9] overflow-hidden bg-black">
          <Image
            src={(product as any).previewImage}
            alt={title}
            fill
      ...
      <div className="flex flex-col flex-1 p-6">
        ...
        <h3 className="font-display font-bold text-lg text-gray-900 dark:text-white mb-2 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">
          {title}
        </h3>
