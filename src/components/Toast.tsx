...
function ToastItem({ toast, onRemove }: { toast: ToastData; onRemove: (id: number) => void }) {
  ...
  return (
    <div
      className={`pointer-events-auto flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-white dark:bg-[#1e1a12] border border-gray-100 dark:border-white/10 shadow-2xl shadow-black/20 transition-all duration-300 ${
