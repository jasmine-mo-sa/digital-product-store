...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-[#fdf7ee]/80bg-[#fdf7ee]/80" />
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-brand-700/65 text-lg max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            {/* Email card */}
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-white bg-white border border-brand-100 shadow-sm">
              ...
              <div>
                <p className="font-semibold text-brand-900 mb-1">{t.contact.emailTitle}</p>
                <a
            ...
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-white bg-white border border-brand-100 shadow-sm">
              ...
              <div>
                <p className="font-semibold text-brand-900 mb-1">{t.contact.socialTitle}</p>
                <p className="text-sm text-brand-700/65">{t.contact.socialDesc}</p>
          ...
          <div className="lg:col-span-3">
            <div className="p-8 rounded-3xl bg-white bg-white border border-brand-100 shadow-sm">
              {submitted ? (
                <div className="flex flex-col items-center justify-center py-12 text-center gap-4">
                  <div className="w-16 h-16 rounded-full bg-green-500/10 flex items-center justify-center">
                    <CheckCircle2 className="w-8 h-8 text-green-500" />
                  </div>
                  <h3 className="text-xl font-bold text-brand-900">{t.contact.successHeading}</h3>
                  <p className="text-brand-700/65 max-w-xs">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-brand-200 bg-brand-50 text-brand-900 placeholder-brand-400/60 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition text-sm"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-brand-800 mb-1.5">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-brand-200 bg-brand-50 text-brand-900 placeholder-brand-400/60 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition text-sm resize-none"
                    />
                  </div>
