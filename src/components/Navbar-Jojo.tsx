...
const CURRENCIES: Currency[] = ["CAD", "EUR", "SAR"];
        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <div ref={langRef} className="relative hidden sm:block">
              ...
              {langOpen && (
                <div className="absolute top-full mt-1.5 right-0 w-28 bg-white dark:bg-overlay border border-gray-100 dark:border-white/10 rounded-xl shadow-xl overflow-hidden z-50">
                  {LANGS.map((l) => (
                    <button
                      key={l}
            ...
            <div ref={currRef} className="relative hidden sm:block">
              ...
              {currOpen && (
                <div className="absolute top-full mt-1.5 right-0 w-24 bg-white dark:bg-overlay border border-gray-100 dark:border-white/10 rounded-xl shadow-xl overflow-hidden z-50">
                  {CURRENCIES.map((c) => (
                    <button
                      key={c}
