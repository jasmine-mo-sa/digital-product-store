...
export const translations = {
  en: {
    ...
    footer: {
      ...
      colSupport: "Support",
      productLinks: ["Resume Templates", "Canva Kits", "Digital Planners", "Bundles"],
  ...
  de: {
    ...
    products: {
      ...
      inCart: "Im Warenkorb",
      added: "Hinzugefügt!",
      viewDownload: "Ansehen / Herunterladen",
      sold: "verkauft",
    ...
    footer: {
      ...
      colSupport: "Support",
      productLinks: ["Lebenslauf-Vorlagen", "Canva-Kits", "Digitale Planer", "Bundles"],
  ...
  ar: {
    ...
    footer: {
      ...
      colSupport: "الدعم",
      productLinks: ["قوالب السيرة الذاتية", "مجموعات Canva", "المخططات الرقمية", "الحزم"],
