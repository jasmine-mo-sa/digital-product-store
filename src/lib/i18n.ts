...
export const translations = {
  en: {
    ...
    success: {
      ...
      thankYou: "Thank you for your purchase! 🎉 Your products are unlocked below.",
      yourProducts: "Your Products",
      viewProduct: "View your product",
      downloadEmail: "Download link coming to your email",
      confirmingPayment: "Confirming your payment…",
      confirmingBody: "If your products don't appear, check your email for access details or contact us below.",
      checkInbox: "Check your inbox!",
      inboxBody: "Your file link will arrive within a few minutes to the email you used at checkout.",
      backToStore: "Back to Store",
      questions: "Questions?",
      yourProductFallback: "Your Product",
    },
  },
  ...
  de: {
    ...
    cart: {
      ...
      checkoutFailed: "Kauf fehlgeschlagen",
    },
    success: {
      heading: "Zahlung erfolgreich!",
      thankYou: "Danke für Ihren Kauf! 🎉 Ihre Produkte sind unten freigeschaltet.",
      yourProducts: "Ihre Produkte",
      viewProduct: "Produkt ansehen",
      downloadEmail: "Download-Link wird an Ihre E-Mail gesendet",
      confirmingPayment: "Zahlung wird bestätigt…",
      confirmingBody: "Falls Ihre Produkte nicht erscheinen, prüfen Sie Ihre E-Mail für Zugangsdaten oder kontaktieren Sie uns unten.",
      checkInbox: "Prüfen Sie Ihr Postfach!",
      inboxBody: "Ihr Datei-Link wird innerhalb weniger Minuten an die E-Mail-Adresse gesendet, die Sie beim Kauf verwendet haben.",
      backToStore: "Zurück zum Shop",
      questions: "Fragen?",
      yourProductFallback: "Ihr Produkt",
    },
  },
  ...
  ar: {
    ...
    success: {
      heading: "تمت عملية الدفع بنجاح!",
      thankYou: "شكراً لشرائك! 🎉 منتجاتك متاحة أدناه.",
      yourProducts: "منتجاتك",
      viewProduct: "عرض المنتج",
      downloadEmail: "رابط التنزيل سيصل إلى بريدك الإلكتروني",
      confirmingPayment: "جارٍ تأكيد الدفع…",
      confirmingBody: "إذا لم تظهر منتجاتك، تحقق من بريدك الإلكتروني للحصول على تفاصيل الوصول أو تواصل معنا أدناه.",
      checkInbox: "تحقق من صندوق الوارد!",
      inboxBody: "سيصل رابط الملف خلال دقائق قليلة إلى البريد الإلكتروني الذي استخدمته عند الشراء.",
      backToStore: "العودة إلى المتجر",
      questions: "أسئلة؟",
      yourProductFallback: "منتجك",
    },
  },
} as const;
